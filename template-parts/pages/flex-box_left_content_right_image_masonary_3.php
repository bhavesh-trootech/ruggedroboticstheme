...
?>
<div id="<?php echo $section_id; ?>" class="work_with_us_main_image_card_main work_with_us_main_image_card_main_3 <?php echo $section_class; ?>">
        <div class="container">
            <div class="work_with_us_main_image_card">
                <div class="information">
                        <?php if(!empty($add_sub_title)): ?>
                        <span class="text_purple text_top"><?php echo $add_sub_title; ?></span>
                         <?php endif; ?>
                        ...
                        <div class="button_wrapper">    
                            <div class="secondary-btns2">
                                <a href="<?php echo $add_button_link; ?>" class="comm_btn btn_underline btn_underline_white rr_dark_border btn_purple"><?php echo $add_button_text; ?>
