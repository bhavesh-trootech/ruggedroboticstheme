...
?>
<section id="<?php echo $section_id; ?>" class="rr_comm_img_con_sec comm_border_line_design comm_doodle_design o_doddle rr_last_img_cont_sec <?php echo $section_class; ?>">
    <div class="container">
